...
$CONFIG["plugins"] =
    "facebook.com,google.com,hotmail.com,live.com,msn.com,myspace.com,twitter.com,yahoo.com,youtube.com,ytimg.com";
...
$CONFIG["options"]["encodeURL"] = [
    "title" => "Encrypt URL",
    "desc" =>
    "Encrypts the URL of the page you are viewing so that it does not contain the target site in plaintext.",
    "default" => true,
    "force" => false,
];

$CONFIG["options"]["encodePage"] = [
    "title" => "Encrypt Page",
    "desc" =>
...
$CONFIG["options"]["showForm"] = [
    "title" => "Show Form",
    "desc" =>
    "This provides a mini form at the top of each page to allow you to quickly jump to another site without returning to our homepage.",
    "default" => true,
    "force" => true,
];

$CONFIG["options"]["allowCookies"] = [
    "title" => "Allow Cookies",
    "desc" =>
...
$CONFIG["options"]["tempCookies"] = [
    "title" => "Force Temporary Cookies",
    "desc" =>
    "This option overrides the expiry date for all cookies and sets it to at the end of the session only - all cookies will be deleted when you shut your browser. (Recommended)",
    "default" => true,
    "force" => true,
];

$CONFIG["options"]["stripTitle"] = [
...
$CONFIG["options"]["stripJS"] = [
    "title" => "Remove Scripts",
    "desc" =>
    "Remove scripts to protect your anonymity and speed up page loads. However, not all sites will provide an HTML-only alternative. (Recommended)",
    "default" => true,
    "force" => false,
];

$CONFIG["options"]["stripObjects"] = [
